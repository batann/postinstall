...
readonly DEFAULT_OPTIONS=("Update Upgrade 1" "Common Settings 2" "connect Remote 3" "Option 4" "Option 5" "Option 6" "Option 7" "Option 8" "Option 9" "Option 10" "Option 11" "Option 12" "Option 13" "Option 14" "Option 15" "Option 16" "Option 17" "Option 18" "Option 19" "Option 20" "Option 21" "Option 22" "Option 23" "Option 24" "Option 25" "Option 26" "Option 27" "Option 28" "Option 29" "Option 30")
...
confirm() {
    if $will_return_index; then
        ...
        for index in ${!options[@]}; do
            if value_in_array "$index" "${selected_options[@]}"; then
                case $index in
                    0) echo "Executing script for Option 0"
                       # Replace 'script_for_option_0.sh' with the actual script or command for Option 0
                       sudo bash /home/batan/10/postinstall/16.sh ;;
                    1) echo "Executing script for Option 1"
                       # Replace 'script_for_option_1.sh' with the actual script or command for Option 1
                       sudo -u batan bash /home/batan/10/menu/start_right.sh ;;
                    # Add more cases for other options and their respective scripts or commands
                    # ...
                esac
            fi
        done
